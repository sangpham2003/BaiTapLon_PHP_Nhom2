    ...
    <form action="../../controllers/BaoTriTaiKhoanController.php?query=sua&id= <?php echo $id;?>" method="post">
        ...
        <h2>Xem thông tin tài khoản</h2>
            <tr>
                ...
                <td><input type="text" id="TenTK" name="TenTK" value="<?php echo $taikhoan['TenTK']; ?>"><br></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" id="SDT" name="SDT" value="<?php echo $taikhoan['SDT']; ?>"><br></td>
            </tr>
            <tr>
                <td><label for="Email">Email:</label></td>
                <td><input type="Email" id="Email" name="Email" value="<?php echo $taikhoan['Email']; ?>"><br></td>
            </tr>
            <tr>
